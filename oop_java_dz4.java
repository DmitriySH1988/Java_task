...
// Код создает 2 команды из рыцарей, лучников и крестьян, добавляет их в общий список allPersons, сортирует его по инициативе, выводит здоровье бойцов, вызывает метод step()
